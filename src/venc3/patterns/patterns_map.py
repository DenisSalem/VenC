...
class PatternsMap():    
    CONTEXTUALS = { # All of the below is loaded from Thread instanciated classes
        ...
        "IfEntriesInPageHaveMetadata":  "if_entries_in_page_have_metadata",
    ...
    NON_CONTEXTUALS = {
        ...
        "entries" : { 
            ...
            "ForEntryMetadataByKeyValue":               "for_entry_metadata_by_key_value",
            "ForEntryMetadataByKeyValueIfExists":       "for_entry_metadata_by_key_value_if_exists",
        ...
        "extra": { # Loaded from function localy imported
            ...
            "DisableMarkup":	          "venc3.patterns.non_contextuals.disable_markup",
            "Escape":                   "venc3.patterns.non_contextuals.escape",
            "GetEmbedContent":	        "venc3.patterns.third_party_wrapped_features.oembed.wrapper_embed_content",
            "GetVenCVersion":	          "venc3.patterns.non_contextuals.get_venc_version",
            "HTML":                     "venc3.patterns.non_contextuals.html",
            "IncludeFile":	            "venc3.patterns.non_contextuals.include_file",
            "IncludeFileIfExists":	    "venc3.patterns.non_contextuals.include_file_if_exists",
            ...
            "SetBackgroundColor":	      "venc3.patterns.non_contextuals.set_background_color",
            "SetColor":	                "venc3.patterns.non_contextuals.set_color",
