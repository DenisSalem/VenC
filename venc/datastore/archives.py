...
class Archives:
    def init_archives(self):
        ...
        compute_archives = (
            ...
            and not self.blog_configuration["disable_archives"]
        )
                ...
                if archives_index is not None:
                    ...
                    self.entries_per_archives.append(
                        MetadataNode(
                            ...
                            entry_index,
                            path="\x1a"
                            + path_archives_sub_folders
                            + quirk_encoding(formatted_date),
